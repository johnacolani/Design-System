...
class _CupertinoIconsTabState extends State<CupertinoIconsTab> {
  ...
  void _loadCupertinoIcons() {
    _allIcons = [
      ...
      CupertinoIcons.check_mark_seal,
      ...
      CupertinoIcons.circle_grid_2x2,
      CupertinoIcons.circle_grid_2x2_fill,
      ...
      CupertinoIcons.delete_thin,
      CupertinoIcons.device_desktop,
      CupertinoIcons.device_laptop,
      CupertinoIcons.device_phone_portrait,
      CupertinoIcons.device_tablet,
      CupertinoIcons.doc,
      ...
      CupertinoIcons.doc_on_folder,
      CupertinoIcons.doc_on_folder_fill,
      CupertinoIcons.doc_person,
      CupertinoIcons.doc_person_fill,
      CupertinoIcons.doc_richtext,
      CupertinoIcons.doc_richtext_fill,
      CupertinoIcons.doc_text,
      CupertinoIcons.doc_text_fill,
      CupertinoIcons.doc_text_search,
      CupertinoIcons.doc_text_viewfinder,
      CupertinoIcons.dollarsign_circle,
      CupertinoIcons.dollarsign_circle_fill,
      CupertinoIcons.dollarsign_square,
      CupertinoIcons.dollarsign_square_fill,
      ...
      CupertinoIcons.eye_slash_solid,
      CupertinoIcons.eyedropper,
      CupertinoIcons.eyedropper_full,
      CupertinoIcons.eyedropper_half,
      CupertinoIcons.face_smiling,
      CupertinoIcons.face_smiling_fill,
      CupertinoIcons.fan,
      CupertinoIcons.fan_fill,
      CupertinoIcons.fan_slash,
      CupertinoIcons.fan_slash_fill,
      CupertinoIcons.film,
      ...
      CupertinoIcons.folder_badge_gear,
      CupertinoIcons.folder_badge_gear_fill,
      CupertinoIcons.folder_badge_minus,
      CupertinoIcons.folder_badge_minus_fill,
      CupertinoIcons.folder_badge_person_crop,
      CupertinoIcons.folder_badge_person_crop_fill,
      CupertinoIcons.folder_badge_plus,
      CupertinoIcons.folder_badge_plus_fill,
      CupertinoIcons.folder_fill,
      CupertinoIcons.forward,
      CupertinoIcons.forward_fill,
      CupertinoIcons.fuel,
      CupertinoIcons.fuel_fill,
      ...
      CupertinoIcons.internal_drive,
      CupertinoIcons.internal_drive_fill,
      CupertinoIcons.largecircle_fill_circle,
      CupertinoIcons.lasso,
      CupertinoIcons.lasso_sparkles,
      ...
      CupertinoIcons.mail,
      CupertinoIcons.mail_stack,
      CupertinoIcons.mail_stack_fill,
      CupertinoIcons.map,
      CupertinoIcons.map_fill,
      CupertinoIcons.maximize,
      CupertinoIcons.memories,
      CupertinoIcons.memories_badge_minus,
      CupertinoIcons.memories_badge_plus,
      CupertinoIcons.menubar_arrow_down_rectangle,
      CupertinoIcons.menubar_rectangle,
      CupertinoIcons.mic,
      ...
      CupertinoIcons.paintbrush_pointed,
      CupertinoIcons.paintbrush_pointed_fill,
      CupertinoIcons.paperclip,
      CupertinoIcons.paperplane,
      CupertinoIcons.paperplane_circle,
      CupertinoIcons.paperplane_circle_fill,
      ...
      CupertinoIcons.person_icloud,
      CupertinoIcons.person_icloud_fill,
      ...
      CupertinoIcons.phone_connection,
      ...
      CupertinoIcons.photo_on_rectangle_angled,
      CupertinoIcons.pin,
      ...
      CupertinoIcons.plus_rectangle_on_folder_fill,
      CupertinoIcons.plus_rectangle_portrait,
      CupertinoIcons.plus_rectangle_portrait_fill,
      CupertinoIcons.plus_slash_minus,
      CupertinoIcons.plus_square,
      CupertinoIcons.plus_square_fill,
      CupertinoIcons.plus_square_on_square,
      CupertinoIcons.plus_square_on_square_fill,
      ...
      CupertinoIcons.rectangle_badge_minus,
      CupertinoIcons.rectangle_badge_plus,
      ...
      CupertinoIcons.rectangle_portrait,
      CupertinoIcons.rectangle_portrait_arrow_left,
      CupertinoIcons.rectangle_portrait_arrow_left_fill,
      CupertinoIcons.rectangle_portrait_arrow_right,
      CupertinoIcons.rectangle_portrait_arrow_right_fill,
      CupertinoIcons.rectangle_portrait_fill,
      CupertinoIcons.rectangle_split_2x1,
      CupertinoIcons.rectangle_split_2x1_fill,
      CupertinoIcons.rectangle_split_2x2,
      CupertinoIcons.rectangle_split_2x2_fill,
      ...
      CupertinoIcons.rewind,
      CupertinoIcons.rewind_fill,
      ...
      CupertinoIcons.share_up_fill,
      CupertinoIcons.shield,
      CupertinoIcons.shield_checkmark,
      CupertinoIcons.shield_checkmark_fill,
      ...
      CupertinoIcons.square_badge_arrow_down,
      CupertinoIcons.square_badge_arrow_down_fill,
      CupertinoIcons.square_badge_arrow_up,
      CupertinoIcons.square_badge_arrow_up_fill,
      CupertinoIcons.square_badge_checkmark,
      CupertinoIcons.square_badge_minus,
      CupertinoIcons.square_badge_plus,
      CupertinoIcons.square_badge_xmark,
      CupertinoIcons.square_circle,
      CupertinoIcons.square_circle_fill,
      CupertinoIcons.square_fill,
      CupertinoIcons.square_fill_on_circle_fill,
      CupertinoIcons.square_fill_on_square,
      ...
      CupertinoIcons.square_on_square_dashed,
      CupertinoIcons.square_on_square_intersection_dashed,
      ...
      CupertinoIcons.square_topthird_split,
      CupertinoIcons.star,
      ...
      CupertinoIcons.star_square,
      CupertinoIcons.star_square_fill,
      ...
      CupertinoIcons.tag_slash_fill,
      CupertinoIcons.target,
      CupertinoIcons.teletype,
      CupertinoIcons.teletype_answer,
      CupertinoIcons.tengesign_circle,
      CupertinoIcons.tengesign_circle_fill,
      CupertinoIcons.tengesign_square,
      CupertinoIcons.tengesign_square_fill,
      ...
      CupertinoIcons.tuningfork_fill,
      CupertinoIcons.turkishlira_sign_circle,
      CupertinoIcons.turkishlira_sign_circle_fill,
      CupertinoIcons.turkishlira_sign_square,
      CupertinoIcons.turkishlira_sign_square_fill,
      CupertinoIcons.tv,
      ...
      CupertinoIcons.video_badge_plus,
      CupertinoIcons.video_badge_plus_fill,
      CupertinoIcons.video_circle,
      CupertinoIcons.video_circle_fill,
      CupertinoIcons.video_fill,
      CupertinoIcons.video_slash,
      CupertinoIcons.video_slash_fill,
      ...
      CupertinoIcons.waveform_path_ecg_rectangle,
      CupertinoIcons.waveform_path_ecg_rectangle_fill,
      CupertinoIcons.wifi,
